## v0_2_1 - 2025-08-05 Rerelease

Changes
- Removed blockchain rebuild since this will be a fresh install.

## v0_2_0 - 2024-09-24 Code Fix

Fixes
- Updated to ICRC79.mo v0_2_2 - See change log at https://github.com/icdevsorg/icrc79.mo/blob/main/CHANGELOG.md
  ...
  - Updates - Added some fields to the product object for convenience
