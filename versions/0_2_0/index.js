...
import { idlFactory } from './subsprod.did.js';
export { idlFactory } from './subsprod.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SUBSPROD;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./subsprod.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the subsprod canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./subsprod.did.js")._SERVICE>}
 */
export const subsprod = createActor(canisterId);
